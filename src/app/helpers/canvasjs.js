(function () {
  ...
  function ua(k, p, D) {
      p.getAttribute("state") ||
          ((p.style.backgroundColor = k.toolbar.backgroundColor), (p.style.color = k.toolbar.fontColor), (p.style.border = "none"), sa(k, p, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
      p.getAttribute("state") !== D &&
          (p.setAttribute("state", D),
          p.setAttribute("type", "button"),
          sa(k, p, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
  ...
  function V(k, p, D, r, v) {
      ...
      this.theme && u(p) && u(r)
          ...
          : this.parent &&
            ...
            (null === r ? (k = this.parent.themeOptions[p]) : 0 < this.parent.themeOptions[p].length && ((r = Math.min(this.parent.themeOptions[p].length - 1, r)), (k = this.parent.themeOptions[p][r])));
      this.themeOptions = k;
  ...
  var Ja = !1,
      ...
      ra = {
          ...
          Toolbar: { backgroundColor: "white", backgroundColorOnHover: "#4cb99f", borderColor: "#4cb99f", borderThickness: 1, fontColor: "black", fontColorOnHover: "white", publicProperties: { options: "readWrite", chart: "readOnly" } },
          Legend: {
              name: null,
      ...
      Ma = { en: {} },
      v = r ? "Trebuchet MS, Helvetica, sans-serif" : "Lab Grotesque",
      Ha = r ? "Impact, Charcoal, sans-serif" : "Lab Grotesque",
      Ba = {
          colorSet1: "#4cb99f #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),
  ...
  var X = 20,
      ...
      Xa = {
          ...
          axisY: [
              {
                  ...
                  gridThickness: 1,
                  gridColor: I,
                  stripLines: [{ labelFontFamily: v, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 2 }],
                  crosshair: { labelFontFamily: v, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ga, color: ha, thickness: 1, lineDashType: "dash" },
                  scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" },
              },
          ],
          ...
          toolTip: { fontFamily: v, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 2 },
      };
  Q = fa = "#F5F5F5";
  I = "#FFFFFF";
  ha = "#40BAF1";
  ...
  V.prototype.addTo = function (k, p, r, u) {
      ...
      v.hasOwnProperty(k) || (v.publicProperties && v.publicProperties.hasOwnProperty(k) && "readWrite" === v.publicProperties[k])
  ...
  V.prototype.addEventListener = function (k, p, r) {
      k && p && ((this._eventListeners[k] = this._eventListeners[k] || []), this._eventListeners[k].push({ context: r || this, eventHandler: p }));
  };
          ...
          "top" === this.verticalAlign || "bottom" === this.verticalAlign
              ...
              : "center" === this.verticalAlign &&
                ("left" === this.horizontalAlign
                    ...
                    : "center" === this.horizontalAlign && ((v = k.y1 + (k.height / 2 - L.height / 2)), (r = k.x1 + (k.width / 2 - L.width / 2)), (I = "center"), (this.width = L.width), (this.height = L.height)),
                (z = "center"));
          H.x = r;
          H.y = v;
          H.angle = E;
  ...
  Na.Chart = (function () {
      ...
      function E(a, d, b, c, e, g, m, l, w, h) {
          ...
          a.beginPath();
          w && 0 < l.thickness
              ? (a.moveTo(c - m.thickness / 2, Math.round((b + e) / 2) - q), a.lineTo(d + m.thickness / 2, Math.round((b + e) / 2) - q))
              : 0 < l.thickness && (a.moveTo(Math.round((d + c) / 2) - q, b + m.thickness / 2), a.lineTo(Math.round((d + c) / 2) - q, e - m.thickness / 2));
          a.stroke();
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                  ...
                  for (n = 0; n < q.dataPoints.length; n++) {
                      ...
                      if (c < p && !f) null !== q.dataPoints[n].y && (k = c);
                          ...
                          null === q.dataPoints[n].y
                              ...
                              : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e), 0 <= e ? (m[c] ? (m[c] += e) : ((m[c] = e), (w = Math.min(e, w)))) : l[c] ? (l[c] += e) : ((l[c] = e), (h = Math.max(e, h))));
                      }
                  }
                  a.axisY.scaleBreaks &&
                      ...
                      (d.dataPointYPositiveSums
                          ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, m), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, l))
              ...
              for (n in l)
                  l.hasOwnProperty(n) &&
                      ...
                      n < b.viewPortMin || n > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, h))));
          }
      };
      p.prototype._processStacked100PlotUnit = function (a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                  ...
                  for (q = 0; q < s.dataPoints.length; q++) {
                      ...
                      if (c < k && !n) null !== e && (B = c);
                          ...
                          null === e
                              ...
                              : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e), 0 <= e ? (m = !0) : 0 > e && (l = !0), (w[c] = w[c] ? w[c] + Math.abs(e) : Math.abs(e)));
                      }
                  }
              ...
              a.axisY.logarithmic
                  ...
                  : !m && l && ((d.max = u(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)), (d.min = u(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
              d.viewPortMin = d.min;
              d.viewPortMax = d.max;
              a.dataPointYSums = w;
          }
                  ...
                  for (s = 0; s < h.dataPoints.length; s++) {
                      ...
                      0 < s &&
                          ...
                          e &&
                              ...
                              (a.axisY.logarithmic
                                  ? ((B = e[0] / h.dataPoints[s - 1].y[0]), 1 > B && (B = 1 / B), d.minDiff > B && 1 !== B && (d.minDiff = B))
                                  : ((B = e[0] - h.dataPoints[s - 1].y[0]), 0 > B && (B *= -1), d.minDiff > B && 0 !== B && (d.minDiff = B))));
                      if (!(c < r) || q) {
                          if (!q && ((q = !0), 0 < s)) {
                              s -= 2;
                              f = k;
                      ...
                      for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, l = f.max, m = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, w = 0, s = 0; s < a.dataSeriesIndexes.length; s++) {
                          ...
                          if (!(4 > k.dataPoints.length))
                              for (w = 0; w < k.dataPoints.length; w++)
                                  if (
                                      (c &&
                                          ((q = ((l + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                      ...
                      if (this._axes[m].scaleBreaks.customBreaks)
                          for (l = 0; l < this._axes[m].scaleBreaks.customBreaks.length; l++)
                              for (c = 0; c < g.length; c++)
                                  if (
                                      (this._axes[m].scaleBreaks.customBreaks[l].startValue <= g[c].start && g[c].start <= this._axes[m].scaleBreaks.customBreaks[l].endValue) ||
                                      (this._axes[m].scaleBreaks.customBreaks[l].startValue <= g[c].start && g[c].start <= this._axes[m].scaleBreaks.customBreaks[l].endValue) ||
                                      (g[c].start <= this._axes[m].scaleBreaks.customBreaks[l].startValue && this._axes[m].scaleBreaks.customBreaks[l].startValue <= g[c].end) ||
                                      (g[c].start <= this._axes[m].scaleBreaks.customBreaks[l].endValue && this._axes[m].scaleBreaks.customBreaks[l].endValue <= g[c].end)
                                  )
                                      g.splice(c, 1), c--;
                      g.sort(function (a, c) {
          ...
          if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
              ...
              if (this.panEnabled || this.zoomEnabled) {
                          ...
                          (b = this._axes[e]),
                              b.logarithmic
                                  ? b.viewportMinimum < b.minimum
                                      ? ((g = b.minimum / b.viewportMinimum), (b.sessionVariables.newViewportMinimum = b.viewportMinimum * g), (b.sessionVariables.newViewportMaximum = b.viewportMaximum * g), (m = !0))
                                      : b.viewportMaximum > b.maximum &&
                                        ((g = b.viewportMaximum / b.maximum), (b.sessionVariables.newViewportMinimum = b.viewportMinimum / g), (b.sessionVariables.newViewportMaximum = b.viewportMaximum / g), (m = !0))
                                  : b.viewportMinimum < b.minimum
                                  ? ((g = b.minimum - b.viewportMinimum), (b.sessionVariables.newViewportMinimum = b.viewportMinimum + g), (b.sessionVariables.newViewportMaximum = b.viewportMaximum + g), (m = !0))
                                  : b.viewportMaximum > b.maximum &&
                                    ((g = b.viewportMaximum - b.maximum), (b.sessionVariables.newViewportMinimum = b.viewportMinimum - g), (b.sessionVariables.newViewportMaximum = b.viewportMaximum - g), (m = !0));
                  ...
                  m &&
                      ...
                      m && this.zoomEnabled && "none" === this._zoomButton.style.display && (Qa(this._zoomButton, this._resetButton), ua(this, this._zoomButton, "pan"), ua(this, this._resetButton, "reset")));
              }
          }
          this.isDrag = !1;
                              ...
                              (function (c, b, e, f) {
                                  return function () {
                                      m._zoomPanToSelectedRegion(c, b, e, f, !0) &&
                                          (m._dispatchRangeEvent("rangeChanging", "pan"), m.render(), m._dispatchRangeEvent("rangeChanged", "pan"), (m.dragStartPoint.x = a), (m.dragStartPoint.y = d));
                                  };
                              })(e.x1, e.y1, e.x2, e.y2),
                              0
                          ));
      ...
      p.prototype.renderIndexLabels = function (a) {
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
              ...
              if (h.dataSeries.indexLabelFormatter || h.dataPoint.indexLabelFormatter) C = { chart: this, dataSeries: h.dataSeries, dataPoint: h.dataPoint, index: h.indexKeyword, total: t.total, percent: t.percent };
              ...
              if (null !== x && "" !== x) {
                  ...
                  if ("normal" === this.plotInfo.axisPlacement) {
                      ...
                      "inside" !== t
                          ? ((e = b.y1),
                            (g = b.y2),
                            0 < ma
                                ? ((n = h.point.y - w - m - c), n < e && ((n = "auto" === t ? Math.max(h.point.y, e) + m + c : e + m + c), (v = n + w > h.point.y)))
                                : ((n = h.point.y + m + c), n > g - w - m - c && ((n = "auto" === t ? Math.min(h.point.y, g) - w - m - c : g - w - m - c), (v = n < h.point.y))))
                          : ((e = Math.max(h.bounds.y1, b.y1)),
                            ...
                            0 < ma
                                ? ((n = Math.max(h.point.y, c) - w / 2), n < e && ("bubble" === s || "scatter" === s) && (n = Math.max(h.point.y - w - m, b.y1 + m)))
                                : ((n = Math.min(h.point.y, c) - w / 2), n > g - w - m && ("bubble" === s || "scatter" === s) && (n = Math.min(h.point.y + m, b.y2 - w - m))),
                            (n = Math.min(n, g - w)));
                  } else
                      0 <= s.indexOf("line") || 0 <= s.indexOf("area") || 0 <= s.indexOf("scatter") ? ((t = "auto"), (e = 4)) : 0 <= s.indexOf("stacked") ? "auto" === t && (t = "inside") : "bubble" === s && (t = "inside"),
                          ...
                          "inside" !== t
                              ? ((m = b.x1),
                                (g = b.x2),
                                0 > ma
                                    ? ((q = h.point.x - l - e - c), q < m && ((q = "auto" === t ? Math.max(h.point.x, m) + e + c : m + e + c), (v = q + l > h.point.x)))
                                    : ((q = h.point.x + e + c), q > g - l - e - c && ((q = "auto" === t ? Math.min(h.point.x, g) - l - e - c : g - l - e - c), (v = q < h.point.x))))
                  ...
                  p &&
                      "inside" !== t &&
                      ((0 > s.indexOf("bar") && ("error" !== s || !h.axisSwapped) && h.point.x > b.x1 && h.point.x < b.x2) || !v) &&
                      ((0 > s.indexOf("column") && ("error" !== s || h.axisSwapped) && h.point.y > b.y1 && h.point.y < b.y2) || !v) &&
                      ((d.lineWidth = p),
                          ...
                          if (((C = s[t].x.getTime ? s[t].x.getTime() : s[t].x), !(C < a.axisX.dataInfo.viewPortMin || (C > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !u)))))
                              if ("number" !== typeof s[t].y) 0 < t && !(h.connectNullData || u || p) && (b.stroke(), r && c.stroke()), (u = !0);
                                  ...
                                  p || u
                                      ? (!p && h.connectNullData
                                            ? (b.setLineDash &&
                                                  ...
                                                  (b.stroke(), b.beginPath(), b.moveTo(m.x, m.y), (q = h.nullDataLineDashType), b.setLineDash(n)),
                                              b.lineTo(C, x),
                                              r && c.lineTo(C, x))
                                  ...
                                  t < s.length - 1 &&
                                      ...
                                      (k = s[t].lineColor || B),
                                      (b.strokeStyle = k),
                                      b.setLineDash && (s[t].lineDashType ? ((q = s[t].lineDashType), b.setLineDash(R(q, h.lineThickness))) : ((q = h.lineDashType), b.setLineDash(f))));
                                  ...
                                  (s[t].indexLabel || h.indexLabel || s[t].indexLabelFormatter || h.indexLabelFormatter) &&
                                      this._indexLabels.push({ chartType: "line", dataPoint: s[t], dataSeries: h, point: { x: C, y: x }, direction: 0 > s[t].y === a.axisY.reversed ? 1 : -1, color: B });
                              }
                      b.stroke();
                      r && c.stroke();
                  }
                      ...
                      for (var u = !1, t = 0; t < s.length; t++)
                          if (((C = s[t].getTime ? s[t].x.getTime() : s[t].x), !(C < a.axisX.dataInfo.viewPortMin || (C > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !u)))))
                              if ("number" !== typeof s[t].y) 0 < t && !(h.connectNullData || u || p) && (b.stroke(), r && c.stroke()), (u = !0);
                                  ...
                                  (s[t].indexLabel || h.indexLabel || s[t].indexLabelFormatter || h.indexLabelFormatter) &&
                                      this._indexLabels.push({ chartType: "stepLine", dataPoint: s[t], dataSeries: h, point: { x: C, y: x }, direction: 0 > s[t].y === a.axisY.reversed ? 1 : -1, color: B });
                              }
                      b.stroke();
                      r && c.stroke();
                  }
                          ...
                          if (((t = s[p].getTime ? s[p].x.getTime() : s[p].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !u)))))
                              if ("number" !== typeof s[p].y)
                                  0 < p &&
                                      !u &&
                                      (h.connectNullData
                                          ? c.setLineDash && 0 < x.length && (h.options.nullDataLineDashType || !s[p - 1].lineDashType) && ((x[x.length - 1].newLineDashArray = n), (q = h.nullDataLineDashType))
                                          : (d(x), (x = []))),
                                      (u = !0);
                              else {
                                  ...
                                  p < s.length - 1 &&
                                      ...
                                      c.setLineDash && (s[p].lineDashType ? ((q = s[p].lineDashType), (x[x.length - 1].newLineDashArray = R(q, h.lineThickness))) : ((q = h.lineDashType), (x[x.length - 1].newLineDashArray = f))));
                                  ...
                                  (s[p].indexLabel || h.indexLabel || s[p].indexLabelFormatter || h.indexLabelFormatter) &&
                                      this._indexLabels.push({ chartType: "spline", dataPoint: s[p], dataSeries: h, point: { x: t, y: u }, direction: 0 > s[p].y === a.axisY.reversed ? 1 : -1, color: B });
                                  u = !1;
                              }
                  d(x);
              }
                      ...
                      for (h = 0; h < t.length; h++)
                          if (((c = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                              ...
                              if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y))
                                  (l[c] = t[h].y + (l[c] ? l[c] : 0)), 0 < l[c] && ((q = a.axisY.convertValueToPixel(l[c])), (y = "undefined" !== typeof g[c] ? g[c] : n), (g[c] = q));
                  ...
                  if (0 < t.length) {
                      ...
                      for (h = 0; h < t.length; h++)
                          if (((c = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                              ...
                              else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) (w[c] = t[h].y + (w[c] ? w[c] : 0)), (s = m[c] ? m[c] : n), (m[c] = y = a.axisY.convertValueToPixel(w[c]));
                  ...
                  if (0 < t.length) {
                      ...
                      for (h = 0; h < t.length; h++)
                          if (((c = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                              ...
                              } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) (w[c] = x + (w[c] ? w[c] : 0)), (s = m[c] ? m[c] : n), (m[c] = x = a.axisY.convertValueToPixel(w[c]));
                              ...
                              c = p.dataPointIds[h];
                              this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: x, y1: v, x2: s, y2: y };
                              c = N(c);
              ...
              for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                  ...
                  if (0 < p.length) {
                      ...
                      for (var da = !0; k < p.length; k++)
                          if (((x = p[k].x.getTime ? p[k].x.getTime() : p[k].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !da)))))
                              if ("number" !== typeof p[k].y) B.connectNullData || da || d || c(), (da = !0);
                                  ...
                                  k < p.length - 1 &&
                                      ...
                                      (T = p[k].lineColor || aa),
                                      (g.strokeStyle = T),
                                      g.setLineDash && (p[k].lineDashType ? ((b = p[k].lineDashType), g.setLineDash(R(b, B.lineThickness))) : ((b = B.lineDashType), g.setLineDash(ca))));
                                  var Z = B.dataPointIds[k];
                                  this._eventManager.objectMap[Z] = { id: Z, objectType: "dataPoint", dataSeriesIndex: f, dataPointIndex: k, x1: t, y1: u };
                                  0 !== p[k].markerSize &&
                                      (0 < p[k].markerSize || 0 < B.markerSize) &&
                                      ((x = B.getMarkerProperties(k, t, u, g)), h.push(x), (Z = N(Z)), r && h.push({ x: t, y: u, ctx: m, type: x.type, size: x.size, color: Z, borderColor: Z, borderThickness: x.borderThickness }));
                                  (p[k].indexLabel || B.indexLabel || p[k].indexLabelFormatter || B.indexLabelFormatter) &&
                                      this._indexLabels.push({ chartType: "area", dataPoint: p[k], dataSeries: B, point: { x: t, y: u }, direction: 0 > p[k].y === a.axisY.reversed ? 1 : -1, color: z });
                              }
                      c();
                      ia.drawMarkers(h);
                  }
                          ...
                          if (((B = n[f].x.getTime ? n[f].x.getTime() : n[f].x), !(B < a.axisX.dataInfo.viewPortMin || (B > a.axisX.dataInfo.viewPortMax && (!q.connectNullData || !k)))))
                              if ("number" !== typeof n[f].y)
                                  ...
                                  (n[f].indexLabel || q.indexLabel || n[f].indexLabelFormatter || q.indexLabelFormatter) &&
                                      this._indexLabels.push({ chartType: "splineArea", dataPoint: n[f], dataSeries: q, point: { x: B, y: k }, direction: 0 > n[f].y === a.axisY.reversed ? 1 : -1, color: ma });
                                  k = !1;
                              }
                      d();
                      ia.drawMarkers(l);
                              ...
                              "number" !== typeof k[p].y
                                  ...
                                  : ((t = a.axisX.convertValueToPixel(x)),
                                    ...
                                    p < k.length - 1 &&
                                        ...
                                        (T = k[p].lineColor || aa),
                                        (g.strokeStyle = T),
                                        g.setLineDash && (k[p].lineDashType ? ((Y = k[p].lineDashType), g.setLineDash(R(Y, B.lineThickness))) : ((Y = B.lineDashType), g.setLineDash(da)))),
                                    (x = B.dataPointIds[p]),
                                    ...
                                    0 !== k[p].markerSize &&
                                        ...
                                        ((Z = B.getMarkerProperties(p, t, u, g)), h.push(Z), (x = N(x)), r && h.push({ x: t, y: u, ctx: m, type: Z.type, size: Z.size, color: x, borderColor: x, borderThickness: Z.borderThickness })),
                          ...
                          if (!(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da))))
                              if ("number" !== typeof Z.y) A.connectNullData || da || C || d(), (da = !0);
                                  ...
                                  C || da
                                      ? (!C && A.connectNullData
                                            ? (c.setLineDash &&
                                                  ...
                                                  ((C = h.pop()), (x = h[h.length - 1]), d(), c.moveTo(t.x, t.y), h.push(x), h.push(C), (x = A.nullDataLineDashType), c.setLineDash(Y)),
                                              c.lineTo(f, k),
                                              r && u.lineTo(f, k))
                                            : (c.beginPath(), c.moveTo(f, k), r && (u.beginPath(), u.moveTo(f, k))),
                                        (da = C = !1))
                                      : (c.lineTo(f, k), r && u.lineTo(f, k), 0 == n % 250 && (d(), c.moveTo(f, k), r && u.moveTo(f, k), h.push({ x: f, y: p - oa })));
                                  t = { x: f, y: k };
                                  n < z.length - 1 &&
                                  ...
                                  0 <= A.dataPointIndexes[g] &&
                                      ...
                                      m.push(oa),
                                      (g = N(la)),
                                      r && m.push({ x: f, y: k, ctx: u, type: oa.type, size: oa.size, color: g, borderColor: g, borderThickness: oa.borderThickness }));
                                  (Z.indexLabel || A.indexLabel || Z.indexLabelFormatter || A.indexLabelFormatter) &&
                                      this._indexLabels.push({ chartType: "stackedArea", dataPoint: Z, dataSeries: A, point: { x: f, y: k }, direction: 0 > z[n].y === a.axisY.reversed ? 1 : -1, color: e });
                              }
                      }
                      d();
                      c.moveTo(f, k);
                          ...
                          if (!(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da))))
                              if ("number" !== typeof Z.y) A.connectNullData || da || u || d(), (da = !0);
                                  ...
                                  u || da
                                      ? (!u && A.connectNullData
                                            ? (c.setLineDash &&
                                                  ...
                                                  ((u = h.pop()), (t = h[h.length - 1]), d(), c.moveTo(p.x, p.y), h.push(t), h.push(u), (t = A.nullDataLineDashType), c.setLineDash(Y)),
                                              c.lineTo(f, k),
                                              r && x.lineTo(f, k))
                                            : (c.beginPath(), c.moveTo(f, k), r && (x.beginPath(), x.moveTo(f, k))),
                                        (da = u = !1))
                                      : (c.lineTo(f, k), r && x.lineTo(f, k), 0 == n % 250 && (d(), c.moveTo(f, k), r && x.moveTo(f, k), h.push({ x: f, y: C - la })));
                                  p = { x: f, y: k };
                                  n < z.length - 1 &&
                                  ...
                                  0 <= A.dataPointIndexes[g] &&
                                      0 !== Z.markerSize &&
                                      (0 < Z.markerSize || 0 < A.markerSize) &&
                                      ((la = A.getMarkerProperties(n, f, k, c)), l.push(la), (g = N(G)), r && l.push({ x: f, y: k, ctx: x, type: la.type, size: la.size, color: g, borderColor: g, borderThickness: la.borderThickness }));
                                  (Z.indexLabel || A.indexLabel || Z.indexLabelFormatter || A.indexLabelFormatter) &&
                                      this._indexLabels.push({ chartType: "stackedArea100", dataPoint: Z, dataSeries: A, point: { x: f, y: k }, direction: 0 > z[n].y === a.axisY.reversed ? 1 : -1, color: e });
                              }
                      }
                      d();
                      c.moveTo(f, k);
                  ...
                  if (((s = a.dataSeriesIndexes[h]), (q = this.data[s]), (n = q.dataPoints), 0 < n.length))
                      for (b.strokeStyle = "#4572A7 ", e = 0; e < n.length; e++)
                          if (((g = n[e].getTime ? (g = n[e].x.getTime()) : (g = n[e].x)), !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y)) {
                              ...
                              this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: e, x1: g, y1: m, size: u };
                              u = N(t);
                  ...
                  if (0 < s.length) {
                      ...
                      for (var q = 0, n = 0, e = 0; e < s.length; e++)
                          if (((g = s[e].getTime ? (g = s[e].x.getTime()) : (g = s[e].x)), !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[e].y)) {
                              ...
                              b.globalAlpha = 1;
                              (Math.sqrt((q - g) * (q - g) + (n - m) * (n - m)) < Math.min(f.size, 5) && s.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                                  ((q = h.dataPointIds[e]),
                                  (this._eventManager.objectMap[q] = { id: q, objectType: "dataPoint", dataSeriesIndex: w, dataPointIndex: e, x1: g, y1: m }),
                                  (q = N(q)),
                  ...
                  if (0 < x.length)
                      for (var z = 5 < k && C.bevelEnabled ? !0 : !1, m = 0; m < x.length; m++)
                          if (
                              ...
                              b.save();
                              0 < la &&
                                  (b.beginPath(), (b.strokeStyle = oa), (b.lineWidth = la), b.setLineDash && b.setLineDash(R(F, la)), b.moveTo(l - G, h), b.lineTo(l - G, w), b.stroke(), b.moveTo(l - G, q), b.lineTo(l - G, s), b.stroke());
                              b.restore();
                              ...
                              r &&
                                  ...
                                  (c.strokeStyle = e),
                                  (c.lineWidth = la),
                                  0 < la && (c.moveTo(l - aa - G, h), c.lineTo(l - aa - G, Math.max(w, q)), c.stroke(), c.moveTo(l - aa - G, Math.min(w, q)), c.lineTo(l - aa - G, s), c.stroke()),
                  ...
                  if (0 < y.length)
                      for (var aa = z._colorSet, l = 0; l < y.length; l++) {
                          ...
                          if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !u(y[l].y) && y[l].y.length && "number" === typeof y[l].y[0] && "number" === typeof y[l].y[1]) {
                              ...
                              c ? (q = ca) : (f = ca);
                              c
                                  ? ((n = a.axisX.reversed ? (h + ((A ? v : 1) * t) / 2 - (A ? D - 1 : 0) * t) << 0 : (h - ((A ? v : 1) * t) / 2 + (A ? D - 1 : 0) * t) << 0), (f = a.axisX.reversed ? (n - t) << 0 : (n + t) << 0))
                  ...
                  if (0 < k.length) {
                      ...
                      for (g = 0; g < k.length; g++)
                          if (
                              ...
                              c = f.dataPointIds[g];
                              this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: g, x1: m, y1: w, x2: l, y2: v };
                              c = N(c);
                          ...
                          if (((t = q[f].x.getTime ? q[f].x.getTime() : q[f].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!s.connectNullData || !T)))))
                              if (null !== q[f].y && q[f].y.length && "number" === typeof q[f].y[0] && "number" === typeof q[f].y[1]) {
                                  ...
                                  n || T
                                      ? (s.connectNullData && !n
                                            ? (c.setLineDash &&
                                              ...
                                              r && e.lineTo(k, p),
                                              w.push({ x: k, y: u }))
                                            : (c.beginPath(), c.moveTo(k, p), (C = { x: k, y: p }), (w = []), w.push({ x: k, y: u }), r && (e.beginPath(), e.moveTo(k, p))),
                                        (T = n = !1))
                                  ...
                                  if (q[f].indexLabel || s.indexLabel || q[f].indexLabelFormatter || s.indexLabelFormatter)
                                      this._indexLabels.push({ chartType: "rangeArea", dataPoint: q[f], dataSeries: s, indexKeyword: 0, point: { x: k, y: p }, direction: q[f].y[0] > q[f].y[1] === a.axisY.reversed ? -1 : 1, color: x }),
                                          this._indexLabels.push({
                                              chartType: "rangeArea",
                                              dataPoint: q[f],
                                              dataSeries: s,
                          ...
                          if (((n = k[q].x.getTime ? k[q].x.getTime() : k[q].x), !(n < a.axisX.dataInfo.viewPortMin || (n > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !f)))))
                              if (null !== k[q].y && k[q].y.length && "number" === typeof k[q].y[0] && "number" === typeof k[q].y[1]) {
                                  ...
                                  q < k.length - 1 &&
                                      ...
                                      c.setLineDash && (k[q].lineDashType ? ((F = k[q].lineDashType), (u[u.length - 1].newLineDashArray = R(F, h.lineThickness))) : ((F = h.lineDashType), (u[u.length - 1].newLineDashArray = y))));
                                  ...
                                  if (k[q].indexLabel || h.indexLabel || k[q].indexLabelFormatter || h.indexLabelFormatter)
                                      this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: k[q], dataSeries: h, indexKeyword: 0, point: { x: n, y: f }, direction: k[q].y[0] <= k[q].y[1] ? -1 : 1, color: t }),
                                          this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: k[q], dataSeries: h, indexKeyword: 1, point: { x: n, y: p }, direction: k[q].y[0] <= k[q].y[1] ? 1 : -1, color: t });
                                  f = !1;
                              } else
                                  0 < q &&
                                      !f &&
                                      (h.connectNullData
                                          ? c.setLineDash && 0 < u.length && (h.options.nullDataLineDashType || !k[q - 1].lineDashType) && ((u[u.length - 1].newLineDashArray = A), (F = h.nullDataLineDashType))
                                          : (d(y, C), (u = []), (z = []))),
                                      (f = !0);
                      d(y, C);
                      ia.drawMarkers(g);
      ...
      var ja = function (a, d, b, c, e, g, m, l, k) {
          if (!(0 > b)) {
              ...
              a.globalAlpha = l;
              "pie" === e
                  ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, b, g, m, !1), (a.fillStyle = c), (a.strokeStyle = "white"), (a.lineWidth = 2), a.closePath(), a.fill())
                  : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, b, g, m, !1), 0 <= k && a.arc(d.x, d.y, k * b, m, g, !0), a.closePath(), (a.fillStyle = c), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
              a.globalAlpha = 1;
              a.restore();
          }
      };
          ...
          function g(a, b, d) {
              ...
              if (0 <= a && a < s.length) {
                  ...
                  var k = 0,
                      ...
                      q = (k = k = 0);
                  0 > b
                      ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > h && n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + b < h && (b = -(h - (n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + b)))
                      : n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 < h && n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + b > l && (b = n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + b - l);
                  ...
                  for (l = 1; l < s.length; l++)
                      if (((h = (a - l + f.length) % f.length), f[h].hemisphere !== f[a].hemisphere)) {
                          ...
                          h !== a &&
                          (0 > c(f[h], f[a]) || ("right" === f[a].hemisphere ? f[h].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y : f[h].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y))
                      )
                          break;
                      else h = null;
                  q = h;
                  ...
                  0 > b
                      ? ((l = "right" === n.hemisphere ? q : k),
                        ...
                        null !== l &&
                            ...
                            b - q < p && ((h = -q), (l = g(l, h, d + 1)), +l.toFixed(C) > +h.toFixed(C) && (m = b > p ? -(b - p) : -(q - (l - h))))))
                      : 0 < b &&
                        ...
                        null !== l &&
                            ...
                            b - q < p && ((h = q), (l = g(l, h, d + 1)), +l.toFixed(C) < +h.toFixed(C) && (m = b > p ? b - p : q - (h - l)))));
                  m &&
                  ...
                  for (a = 0; a < s.length; a++)
                      if (((l = f[a]), (y = l.indexLabelTextBlock.measureText()), 0 !== y.height && 0 !== y.width))
                          (y = y = 0),
                              ...
                              0 < y &&
                                  (!m && l.indexLabelText && ((u = 0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI ? -1 : 1), 0 === g(a, y * u) && g(a, 2 * u)),
                  ...
                  (a = (Math.abs(C[l].y) * f) / g),
                      m
                          ...
                          : ((k = ba * ba * b * b - 4 * Math.abs(ba) * a),
                            0 > k
                                ? ((k = c), (m = ((b + k) * (d - h)) / 2), (a -= m), (n = d - h), (h += d - h), (n += 0 == k ? 0 : a / k), (h += a / k), (m = !0))
                                : ((n = (Math.abs(ba) * b - Math.sqrt(k)) / 2),
                                  (k = b - (2 * n) / Math.abs(ba)),
                                  (h += n),
                                  h > d && ((h -= n), (k = c), (m = ((b + k) * (d - h)) / 2), (a -= m), (n = d - h), (h += d - h), (n += a / k), (h += a / k), (m = !0)),
                                  (b = k))),
                      e.push(n);
              return e;
          }
              ...
              if (d)
                  for (h = J.length - 1; 0 <= h; h--)
                      (a = P[h]),
                          ...
                          t.reversed
                              ? (J[h].textBlock.y + J[h].height > pa + D && (J[h].textBlock.y = pa + D - J[h].height), J[h].textBlock.y < wa - D && (J[h].textBlock.y = wa - D))
          ...
          function m() {
              ...
              for (var d, e, f, g, h, m, k = 1, s = 0; s < 2 * k; s++) {
                  for (
                      ...
                      (e = +g.y.toFixed(6)),
                      !f.isDirty && h && e + d + ga > +m.y.toFixed(6) && ((d = g.y + d + ga - m.y), (e = a(w, -d)), e < d && (0 < e && (d -= e), (e = a(n(w), d)), e != d)));
                      w--
                  );
                  b();
              }
      ...
      H.prototype.setLayout = function () {
          ...
          var k = [],
              h = [];
          "top" === this.verticalAlign || "bottom" === this.verticalAlign
              ? ((this.orientation = "horizontal"), (b = this.verticalAlign), (g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width), (m = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height))
              : "center" === this.verticalAlign &&
                ((this.orientation = "vertical"), (b = this.horizontalAlign), (g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width), (m = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height));
                  ...
                  if (!(0 >= m || "undefined" === typeof m || 0 >= v || "undefined" === typeof v)) {
                      if ("horizontal" === this.orientation) {
                          ...
                          (n.textBlock = new ka(this.ctx, {
                              ...
                              n.textBlock.measureText(),
                              null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (r + l + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                              this.height < m - this.lineHeight ? ((q = { items: [], width: 0 }), h.push(q)) : ((q = h[z]), (z = (z + 1) % h.length)),
                              ...
                              if (u(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                  if (
                                      ((this.sessionVariables.labelMaxHeight =
                                          0 === this.labelAngle ? m : Math.min((c - g * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)), c)),
                      ...
                      for (b = 0; b < this._labels.length; b++)
                          if (!this._labels[b].breaksLabelType) {
                              ...
                              u(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle
                                  ...
                                  : this.options.labelWrap
                                  ? ((this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? m : c), (this.sessionVariables.labelWrap = this.labelWrap), (this.sessionVariables.labelMaxWidth = g))
                                  : ((this.sessionVariables.labelMaxHeight = m),
                                    u(this.options.labelMaxWidth),
                          ...
                          a[f] &&
                              ...
                              !a[f] ||
                                  ...
                                  0 < a[f].labelAngle
                                      ...
                                      : 0 > a[f].labelAngle
                                      ? A - z < m && A - z < a[f].viewportMinimum && (F = m - (K + a[f].tickLength + D + A - z + a[f].labelFontSize / 2))
                                      : 0 === a[f].labelAngle && (E + t > k && (l = E + t / 2 - k - ba), A - z < m && A - z < a[f].viewportMinimum && (F = m - K - a[f].tickLength - D - A + z / 2)),
                                  a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 < a[f].labelAngle && 0 < l
                                      ...
                                      ? (m += F)
                                      : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 === a[f].labelAngle && (0 < F && (m += F), 0 < l && (k -= l))),
                      ...
                      for (f = 0; f < a.length; f++)
                          a[f] &&
                              ...
                              a[f]._labels &&
                                  ...
                                  (E = a[f].logarithmic
                                      ? (1 < m ? (Math.log(m) / a[f].conversionParameters.lnLogarithmBase) * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1
                      ...
                      for (f = 0; f < d.length; f++)
                          d[f].calculateValueToPixelConversionParameters(),
                              ...
                              d[f]._labels &&
                                  ...
                                  (E = d[f].logarithmic
                                      ? (1 < m ? (Math.log(m) / d[f].conversionParameters.lnLogarithmBase) * Math.abs(d[f].conversionParameters.pixelPerUnit) : 0) + d[f].lineCoordinates.x1
                  ...
                  if (b && 0 < b.length)
                      for (f = 0; f < b.length; f++)
                          (b[f].lineCoordinates = {}),
                              ...
                              b[f].labelAutoFit &&
                                  !u(C) &&
                                  (0 < !a.length && (m = 0 > b[f].labelAngle ? Math.max(m, C) : 0 === b[f].labelAngle ? Math.max(m, C / 2) : m),
                  ...
                  if (c && 0 < c.length)
                      for (f = 0; f < c.length; f++)
                          (c[f].lineCoordinates = {}),
                              ...
                              c[f] && c[f].labelAutoFit && !u(D) && (0 < !a.length && (m = 0 < c[f].labelAngle ? Math.max(m, D) : 0 === c[f].labelAngle ? Math.max(m, D / 2) : m), 0 < !d.length && (k -= y / 2)),
                  ...
                  if (b && 0 < b.length)
                      for (f = b.length - 1; 0 <= f; f--)
                          (l = Math.round(g.y2)),
                              ...
                              (b[f].bounds = { x1: m, y1: l - (q[f] + X + b[f].margin), x2: k, y2: h - (X + b[f].margin), width: k - m, height: q[f] }),
                              b[f].title && (b[f]._titleTextBlock.maxWidth = 0 < b[f].titleMaxWidth && b[f].titleMaxWidth < b[f].lineCoordinates.width ? b[f].titleMaxWidth : b[f].lineCoordinates.width),
                              (X += q[f] + b[f].margin);
                  if (c && 0 < c.length)
      ...
      z.prototype.renderLabelsTicksAndTitle = function () {
                  ...
                  if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                      for (var b = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, m, l = this.viewportMaximum, k = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                          ...
                          q.position > this.viewportMaximum ||
                              ...
                              (b.push(q), (l = q.position), (m = q.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
                      }
                      this._labels = b;
                  } else {
                      for (h = 0; h < this._labels.length; h++)
                          (q = this._labels[h]),
                              q.position < this.viewportMinimum || ((m = q.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (b += m));
          ...
          else for (h = 0; h < this._labels.length; h++) (q = this._labels[h]), q.position < this.viewportMinimum || q.position > this.viewportMaximum || (d && 0 !== g++ % 2 && this.labelAutoFit) || q.textBlock.render(!0);
      };
                              ...
                              "bottom" === this._position
                                  ? ((b.textBlock.maxWidth = this.options.stripLines[c].labelMaxWidth ? this.options.stripLines[c].labelMaxWidth : this.chart.plotArea.height - 3),
                                    ...
                                    a.x - b.textBlock.height > this.chart.plotArea.x1
                                        ...
                                        : ((b.textBlock.angle = 90), u(h.startValue) ? (a.x += b.textBlock.height - b.textBlock.fontSize / 2) : (a.x += b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3)),
                                    (a.y =
      ...
      z.prototype.calculateLogarithmicAxisParameters = function () {
          ...
          if (this.scaleBreaks)
              for (m = 0; m < this.scaleBreaks._appliedBreaks.length; m++)
                  if (
                      ((!u(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[m].startValue) ||
                          (!u(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[m].startValue) ||
                          (!u(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[m].startValue)) &&
                      ((!u(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[m].endValue) ||
          ...
          "axisX" === this.type
              ? ((c = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin),
                ...
                1 === e / c && ((m = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval)), (e *= m), (c /= m)),
              ...
              : "axisY" === this.type &&
                ...
                1 === c && 1 === e
                    ...
                    : 1 === e / c
                    ? ((m = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), (e *= m), (c /= m))
                    : c > e
                    ? ((m = Math.min((c / e) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), 1 <= e ? (c = e / m) : (e = c * m))
                    : ((m = Math.min((e / c) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))), 1 !== e && (e *= m), 1 !== c && (c /= m)),
                (g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / c > this.logarithmBase ? (e / c) * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase),
          ...
          1 === this.viewportMaximum &&
              ...
              this.options &&
                  ...
                  ((this.interval = z.getNiceExponent(Math.ceil(Math.log(m) / d) / (a - 1))), (b = z.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
          if (null === this.minimum || null === this.maximum)
              "axisX" === this.type
      ...
      fa.prototype.render = function (a, d) {
          ...
          if (this.snapToDataPoint) {
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                  ...
                  if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                      for (var f = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[0])), v = 0, n = 0; n < m.length; n++)
                          if (m[n].dataPoint.y && m[n].dataPoint.y.length) for (k = 0; k < m[n].dataPoint.y.length; k++) (v = Math.abs(a - this.parent.convertValueToPixel(m[n].dataPoint.y[k]))), v < f && ((f = v), (r = n));
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) {
                      ...
                      if ("rangeBar" === this.parent.dataSeries[r].type || "error" === this.parent.dataSeries[r].type) {
                          ...
                          l.text = this.labelFormatter
                              ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: k.dataPoint.y[b] })
                          ...
                          l.text = this.labelFormatter
                              ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: k.dataPoint.y })
                              : u(this.options.label)
                          ...
                          if ("axisX" === this.parent.type)
                              for (n = this.parent.convertPixelToValue({ y: d }), f = null, r = 0; r < this.parent.dataSeries.length; r++)
                                  (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) &&
                                      0 <= f.index &&
                                      (l.text = this.labelFormatter
                                          ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: k.dataPoint.x })
                                          : u(this.options.label)
                                          ? f.dataPoint.label
                                          : this.label);
                      } else
                  ...
                  if (
                      ...
                      for (f = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), n = v = 0; n < m.length; n++)
                          if (m[n].dataPoint.y && m[n].dataPoint.y.length) for (k = 0; k < m[n].dataPoint.y.length; k++) (v = Math.abs(d - this.parent.convertValueToPixel(m[n].dataPoint.y[k]))), v < f && ((f = v), (r = n));
                  ...
                  if (
                      ...
                      "waterfall" === this.parent.dataSeries[r].type
                          ? ((m =
                            ...
                            (l.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: k.dataSeries.dataPointEOs[k.index].cumulativeSum })
                                : u(this.options.label)
                                ? ba(k.dataSeries.dataPointEOs[k.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo)
                                : this.label))
                          : ((m = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(k.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(k.dataPoint.y) << 0),
                            (l.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: k.dataPoint.y })
              ...
              ("bottom" === this.parent._position || "top" === this.parent._position) &&
                  ...
                  (0 < h && (p.moveTo(b, e), p.lineTo(c, g), p.stroke()), p.restore(), !u(l.text) && ("number" === typeof l.text.valueOf() || 0 < l.text.length) && l.render(!0));
              ...
              if ("bottom" === this.parent._position || "top" === this.parent._position)
                  ...
                  (e = g = m = 1 === p.lineWidth % 2 ? (d << 0) + 0.5 : d << 0), (b = this.chart.plotArea.x1), (c = this.chart.plotArea.x2), (this.bounds = { x1: b, y1: e - h / 2, x2: c, y2: g + h / 2 });
              if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                  if ("left" === this.parent._position || "right" === this.parent._position) {
                      t = !1;
                      if (this.parent.labels)
                          ...
                          if (h.dataSeries.axisY)
                              if (0 < h.dataPoint.y.length) {
                                  ...
                                  "column" === e.type || "bar" === e.type
                                      ? 0 > h.dataPoint.y
                                          ? 0 > h.dataSeries.axisY.viewportMinimum && h.dataSeries.axisY.viewportMaximum >= h.dataPoint.y && g.push(h)
                                          : h.dataSeries.axisY.viewportMinimum <= h.dataPoint.y && 0 <= h.dataSeries.axisY.viewportMaximum && g.push(h)
                                      : "bubble" === e.type
                                      ? ((b = this.chart._eventManager.objectMap[e.dataPointIds[h.index]].size / 2),
                                        h.dataPoint.y >= h.dataSeries.axisY.viewportMinimum - b && h.dataPoint.y <= h.dataSeries.axisY.viewportMaximum + b && g.push(h))
                                      : "waterfall" === e.type
                                      ? ((b = 0),
                  ...
                  (b = a[l].dataSeries),
                      ...
                      0 === l &&
                          ...
                          (this.chart.axisX && 0 < this.chart.axisX.length
                              ? (h += "undefined" !== typeof this.chart.axisX[0].labels[c.x] ? this.chart.axisX[0].labels[c.x] : "{x}")
                              : this.chart.axisX2 && 0 < this.chart.axisX2.length && (h += "undefined" !== typeof this.chart.axisX2[0].labels[c.x] ? this.chart.axisX2[0].labels[c.x] : "{x}"),
                          (h += "</br>"),
                  ...
                  if (b) {
                      ...
                      "circle" === c
                          ? (b.moveTo(a, d),
                            ...
                            g && b.fill(),
                            l && (k ? b.stroke() : ((p = b.globalAlpha), (b.globalAlpha = 0.15), (b.strokeStyle = "black"), b.stroke(), (b.globalAlpha = p))))
                          : "square" === c
                          ? (b.beginPath(), b.rect(a - e / 2, d - e / 2, e, e), g && b.fill(), l && (k ? b.stroke() : ((p = b.globalAlpha), (b.globalAlpha = 0.15), (b.strokeStyle = "black"), b.stroke(), (b.globalAlpha = p))))
                          : "triangle" === c
                          ? (b.beginPath(),
